...
Technical domains often don't allow to use of spaces within the name. However,
the following ways of writing Server State in technical domains are acceptable.
Always use the first suitable choice from the list.
