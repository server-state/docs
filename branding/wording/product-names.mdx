...
after first calling it by this full name, it’s possible to either abbreviate
Server State to SerSta or drop the prefix all together:

> “SerSta [product name]”

> “[product name]”

We allow this when it’s clear from context that the product belongs to the
Server State ecosystem.
